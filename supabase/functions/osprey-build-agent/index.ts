...
{
  "system_prompt": "Complete system prompt for ${name} (400-700 words). Define: who this agent is, their personality, their specific capabilities, what data they access, how they speak in staff meetings (brief, focused, with their unique voice), and what their dashboard shows Shannon. MUST end with a GROUNDING RULES section: only state facts from the data actually provided; if data is missing, say so plainly instead of inventing names, numbers, sources, or events; every factual claim must be traceable to its source on request.",
